 ...
 * Clickable card that navigates to restaurant detail page
 * 
 * @param {Object} props - Component props
 * @param {Object} props.restaurantData - Restaurant data from API
 */
const RestaurantCard = ({ restaurantData }) => {
  // Destructure restaurant information from props
  const {
    cloudinaryImageId,
    name,
    areaName,
  ...
  /**
   * Truncate text if it exceeds specified length
    ...
    >
      <div className="restaurant-card">
        ...
        <div className="restaurant-details">
          ...
          <div className="esa-rating">
            <div className="rating">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ marginRight: "4px" }}>
                <circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear)"></circle>
                ...
                <defs>
                  <linearGradient id="StoreRating20_svg__paint0_linear" x1="10" y1="1" x2="10" y2="19">
            ...
            <span>{deliveryTime || "30-35"} mins</span>
          </div>
          ...
          {/* Location */}
          <div className="location">{areaName || "Unknown location"}</div>
        </div>
      </div>
    </Link>
  );
